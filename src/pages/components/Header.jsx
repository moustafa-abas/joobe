...
<form className="  d-flex align-items-center ms-4 position-relative" role="search">
        ...
        <li className='me-4'><NavLink className='text-decoration-none'  activeClassName="active" to={"/home"}>Home</NavLink></li>
...
{isLogined?<>
        ...
        <ul className='m-0  d-flex d-lg-none flex-column  justify-content-between align-items-center '>
            <li className='me-3'><NavLink className='text-decoration-none'  activeClassName="active" to={"/home "}>Home</NavLink></li>
