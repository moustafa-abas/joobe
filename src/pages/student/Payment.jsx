...
<label htmlFor="visa" className='d-flex  justify-content-between align-items-center'><div className=' d-flex flex-column gap-3'>**** 8304
    <h6>Visa.Edit</h6></div> <img src={visa} alt="" /></label>
</div>
<div className=" radioGroup d-flex w-50 align-items-center gap-4  p-3 mt-3">
<input type="radio" id="master" name="pay" value="master"  />
<label htmlFor="master" className='d-flex  justify-content-between align-items-center'><div className=' d-flex flex-column gap-3'>**** 8304
    <h6>Master.Edit</h6></div> <img src={master} alt="" /></label>
</div>
</div>
