...
<div className="applyJob position-relative pb-5">
    ...
    <div className="Container position-absolute top-50">
        ...
        <p className="fw-light fs-5 my-5">
    ...
    <div className="state d-flex flex-column">
        ...
        <p className="active d-flex    fs-5 my-4">
        {" "}
        <img src={active} alt="" className="me-3 " />
        Active for 10 days{" "}
        <img className="ms-5 me-3" src={jobLocation} alt="" />
        {job.type}
        </p>
        <p>4 weeks ago • Over 200 applicants 9 connections</p>
    </div>
    <div className="info my-4">
        <h5 className="fw-semibold d-flex align-items-center my-4">
        <img className="me-4 " src={location} alt="" />
        {job.location}
        </h5>
        <h5 className="fw-semibold d-flex align-items-center my-4">
        <img className="me-4 " src={experience} alt="" />
        {job.exp} years experience
        </h5>
        <h5 className="fw-semibold d-flex align-items-center my-4">
        <img className="me-4 " src={salary} alt="" />
        {job.salary}$ monthly
        </h5>
    </div>
    <div className="text my-5">
        <h2 className="fw-semibold">About Jop</h2>
        <p className="fs-4 my-4 w-50">
        {job.about} “”<span className="fw-bold"> {job.track} </span> “”{" "}
        </p>
        ...
        <ul className="my-4">
            ...
            <li className="fs-4 my-3  " key={one}>
                {one}
            </li>
            ))}
        </ul>
        ...
        <p className="w-75 fs-4 my-4">
        At Innova Hub , we are at the forefront of software innovation,
        dedicated to creating cutting-edge solutions that transform
        industries. As we continue to push boundaries, we recognize the
        crucial role that design plays in communicating our brand and
        product vision.
        </p>
    </div>
    <button
    ...
    <div className="apply position-absolute top-0 start-0  bottom-0 end-0">
        ...
        >
            ...
            <p className="error text-danger mt-2 text-start">
            {errors.cv?.message}
            </p>

            <button type="submit" className="my-5 me-5 py-4">
            {" "}
            Apply
            </button>
            <button
